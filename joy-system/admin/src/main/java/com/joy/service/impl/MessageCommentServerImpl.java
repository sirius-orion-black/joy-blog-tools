...
@Service
@Slf4j
public class MessageCommentServerImpl extends ServiceImpl<MessageCommentMapper, MessageComment> implements MessageCommentServer {

    @Autowired
    private MessageCommentMapper commentMapper;
    /**
     *
     * @param params 参数
     * @return 返回数据
     */
    @Override
    public Page<MessageComment> getComment(CommentParamDto params) {
        Page<MessageComment> page = new Page<>(params.getPage(),params.getSize());
