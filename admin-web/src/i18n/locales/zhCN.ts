export default {
  ...
  request: {
    ...
    verification_code_expired: '验证码已失效，请重新获取',
    ...
    article_not_exist: '没有符合条件的文章',
    invalid_operation: '无效操作',
    articles_column_nothing: '没有符合条件的文章栏目',
    failed_obtain_puzzle_resources: '获取拼图资源失败',
    image_conversion_base64_failed: '图片资源转换BASE64失败',
    many_verification_errors_retrieve: '验证码错误次数过多，请重新获取',
    verification_code_seconds: '请[]秒后再获取验证码',
    verification_codes_frequently: '该邮箱获取验证码过于频繁，请1小时后再试',
    maximum_verification_codes_today: '该邮箱今日获取验证码次数已达上限，请明天再试',
    network_requests_frequent: '当前网络请求过于频繁，请稍后再试',
